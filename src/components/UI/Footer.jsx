      ...
      <footer className={classes.footer}>
          ...
          <Grid className={classes.mainContainer} container justify="center">
            <Grid item className={classes.gridItem}>
              <Grid container direction="column" spacing={2}>
                <Grid className={classes.link} item component={Link} to="/" onClick={() => setValue(0)}>
                  Home
                </Grid>
              </Grid>
            </Grid>
        ...
        <Grid className={classes.socialContainer} container justify="flex-end" spacing={2}>
          <Grid
            ...
            target="_blank"
          >
            <img src={facebook} alt="Facebook logo" className={classes.iconFacebook}/>
          </Grid>
          <Grid
            item
            component={"a"}
            ...
            target="_blank"
          >
            <img src={twitter} alt="Twitter logo" className={classes.iconTwitter}/>
          </Grid>
          <Grid
            item
            component={"a"}
            ...
            target="_blank"
          >
            <img src={instagram} alt="Instagram logo" className={classes.iconInstagram}/>
          </Grid>
        </Grid>
      </footer>
  );
